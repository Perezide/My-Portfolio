  ...
  return (
    <section id="about" className="py-20 bg-white dark:bg-gray-900">
      <div className="overflow-hidden max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                ...
                >
                  ...
                  <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2">
                    <div className={`w-4 h-4 rounded-full ${colorClass.dot} border-4 border-white dark:border-gray-800`}></div>
                  </div>
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 max-w-4xl mx-auto border border-gray-200 dark:border-gray-700 shadow-lg">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-400 leading-relaxed">
              ...
              create intelligent solutions in <strong className="text-gray-800 dark:text-gray-300">AI</strong>, <strong className="text-gray-800 dark:text-gray-300">IoT</strong>, <strong className="text-gray-800 dark:text-gray-300">Telecommunications</strong>, 
              and <strong className="text-gray-800 dark:text-gray-300">Electronic Devices</strong>. My goal is to build impactful startups and global enterprise 
