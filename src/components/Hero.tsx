  ...
  return (
    <section id="home" className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-white/30 dark:from-slate-800/20 dark:to-slate-900/10"></div>
        ...
        {/* Floating Elements */}
        <motion.div
          className="absolute top-1/4 left-1/6 w-40 h-40 bg-blue-200/30 dark:bg-blue-900/20 rounded-full border border-white/30 dark:border-blue-800/30"
          animate={{ 
            y: [0, -30, 0],
            scale: [1, 1.1, 1]
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/3 right-1/5 w-48 h-48 bg-slate-200/20 dark:bg-slate-700/20 rounded-full border border-white/20 dark:border-slate-600/20"
          animate={{ 
            y: [0, 20, 0],
            scale: [1, 1.05, 1]
          }}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
        <div className="text-center w-full">
          <motion.div
            ...
            className="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 border border-gray-200 dark:border-slate-700 shadow-xl"
          >
            ...
            >
              {[
                ...
                <motion.div
                  key={item.label}
                  className="flex items-center space-x-2 px-4 py-3 rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm"
            ...
            {/* Specialization */}
            <motion.p
              className="text-lg text-gray-700 dark:text-slate-300 mb-8 leading-relaxed max-w-2xl mx-auto"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              {[Code2, Cpu, Zap].map((Icon, index) => (
                <motion.div
                  key={index}
                  className="p-3 rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm"
            ...
            {/* Call to Action */}
            <motion.p
              className="text-base text-gray-600 dark:text-slate-400 max-w-2xl mx-auto mt-8"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
